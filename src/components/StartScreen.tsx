...
const startingPoints: StartingPoint[] = [
  {
    ...
    description: 'Uncover buried memories and hidden experiments in a small town with dark secrets. Your investigation reveals a global conspiracy that spans dimensions and challenges the very nature of consciousness itself.',
