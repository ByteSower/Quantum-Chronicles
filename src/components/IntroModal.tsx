...
const IntroModal: React.FC<IntroModalProps> = ({ onClose, onShowAbout }) => (
  <div className="fixed inset-0 z-50 flex items-center justify-center bg-black bg-opacity-80">
    <div className="max-w-xl mx-auto bg-gradient-to-b from-slate-800 to-slate-900 p-6 rounded-lg shadow-2xl text-center border border-indigo-500/30">
      ...
      <div className="flex flex-col sm:flex-row gap-3 mt-6">
        <button
          onClick={onClose}
          className="flex-1 bg-gradient-to-r from-indigo-600 to-purple-600 hover:from-indigo-700 hover:to-purple-700 text-white rounded-lg px-6 py-3 font-semibold transition-all duration-300 shadow-lg"
        >
          Start Reading
        </button>
        {onShowAbout && (
          <button
            ...
            className="flex-1 bg-gray-700 hover:bg-gray-600 text-white rounded-lg px-6 py-3 font-medium transition-all duration-300"
          >
            Learn More About QNCE
          </button>
        )}
      </div>
